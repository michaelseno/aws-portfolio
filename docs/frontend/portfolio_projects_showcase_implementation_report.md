...
Implemented a homepage revamp that broadens the portfolio narrative, moves featured work directly under the hero, and presents exactly three evidence-backed project cards for CashFlow Tracker, ReliabilityKit, and TestOrbit. Follow-up QA fixes added portfolio-hosted proof pages for CashFlow Tracker and TestOrbit repository evidence where direct public repo linking was not safe.
...
- CashFlow Tracker still lacks a public repo or live demo, so proof remains documentation-based.
